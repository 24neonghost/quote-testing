...
export default function ProductDialog({ product }: { product?: Product }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      {/* Increased Modal Width and Height to 95vw/95vh */}
          ...
          <div className="flex-grow overflow-y-auto p-10 space-y-10">
            ...
            <div className="flex flex-col gap-12 lg:flex-row">
              ...
              <div className="flex-shrink-0">
                ...
                <div className="group relative flex h-72 w-72 lg:h-96 lg:w-96 items-center justify-center overflow-hidden rounded-3xl border-2 border-dashed border-gray-200 bg-gray-50 transition-all hover:border-gray-300">
                  {previewUrl ? (
              ...
              <div className="flex-1 space-y-8">
                <div className="grid gap-8 sm:grid-cols-2">
                  <div className="space-y-3">
                    ...
                    {/* Increased Input Heights to h-14 and text size */}
                    <Input
                      id="name"
                      name="name"
